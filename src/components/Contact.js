    ...
    return (
      <div {...styles.container}>
        <Text title="CONTATO" subtitle='Entre para a nossa comunidade'>
          ...
          <span>
            <a title='slack' href="http://react-brasil-slack.herokuapp.com" target="_blank">
          ...
          <span>
            <a title='twitter' href="http://twitter.com/reactconfbr" target="_blank">
          ...
          <span>
            <a title='github' href="https://github.com/react-brasil" target="_blank">
              <svg id="github" x="0px" y="0px" width='48px' height='48px' viewBox="0 0 438.536 438.536">
                <g>
                  <g>
                    <path fill="gray" d="M158.173,352.599c-3.049,0.568-4.381,1.999-3.999,4.281c0.38,2.283,2.093,3.046,5.138,2.283
                      c3.049-0.76,4.38-2.095,3.997-3.997C162.931,353.074,161.218,352.216,158.173,352.599z"/>
                    <path fill="gray" d="M141.898,354.885c-3.046,0-4.568,1.041-4.568,3.139c0,2.474,1.619,3.518,4.853,3.138c3.046,0,4.57-1.047,4.57-3.138
                      C146.753,355.553,145.134,354.502,141.898,354.885z"/>
                    <path fill="gray" d="M119.629,354.022c-0.76,2.095,0.478,3.519,3.711,4.284c2.855,1.137,4.664,0.568,5.424-1.714
                      c0.572-2.091-0.666-3.61-3.711-4.568C122.197,351.265,120.39,351.922,119.629,354.022z"/>
                    <path fill="gray" d="M414.41,24.123C398.326,8.042,378.964,0,356.309,0H82.225C59.577,0,40.208,8.042,24.123,24.123
                    ...
                    <path fill="gray" d="M86.793,319.195c-1.331,0.948-1.141,2.471,0.572,4.565c1.906,1.902,3.427,2.189,4.57,0.855
                      c1.331-0.948,1.141-2.471-0.575-4.569C89.458,318.336,87.936,318.049,86.793,319.195z"/>
                    <path fill="gray" d="M77.374,312.057c-0.57,1.335,0.096,2.478,1.999,3.426c1.521,0.955,2.762,0.767,3.711-0.568
                      c0.57-1.335-0.096-2.478-1.999-3.433C79.182,310.91,77.945,311.102,77.374,312.057z"/>
                    <path fill="gray" d="M95.646,330.331c-1.715,0.948-1.715,2.666,0,5.137c1.713,2.478,3.328,3.142,4.853,1.998c1.714-1.334,1.714-3.142,0-5.427
                      C98.978,329.571,97.359,328.993,95.646,330.331z"/>
                    <path fill="gray" d="M105.641,343.174c-1.714,1.526-1.336,3.327,1.142,5.428c2.281,2.279,4.185,2.566,5.708,0.849
          ...
          <span>
            <a title='facebook' href="https://www.facebook.com/reactconf/" target="_blank">
              <svg id="facebook" width='48px' height='48px' viewBox="0 0 510 510">
                <g>
                  <g id="post-facebook">
                    <path fill="gray" d="M459,0H51C22.95,0,0,22.95,0,51v408c0,28.05,22.95,51,51,51h408c28.05,0,51-22.95,51-51V51C510,22.95,487.05,0,459,0z
